...
{
    public class KatanaStatsReportInfoElement : IBestiaryInfoElement, IUpdateBeforeSorting
    {
        public delegate void StatAdjustmentStep(KatanaStatsReportInfoElement element);
        ...
        private ModItem _instance;

        public event StatAdjustmentStep OnRefreshStats;

        public KatanaStatsReportInfoElement(int katanaId)
        {
            KatanaID = katanaId;
            _instance = ModContent.GetModItem(katanaId);
        ...
        private void RefreshStats(ModItem instance)
        {
            Damage = instance.Item.damage;
            KnockBack = instance.Item.knockBack;
            SoldValue = instance.Item.damage;
            SwingSpeed = instance.Item.damage;
        ...
        public UIElement ProvideUIElement(BestiaryUICollectionInfo info)
        {
            ...
            UIImage uIImage3 = new UIImage(Main.Assets.Request<Texture2D>("Images/UI/Bestiary/Stat_Attack"))
            {
                Top = new StyleDimension(num4 + num2, 0f),
            ...
            string text5 = Damage.ToString();
            string text6 = KnockBack.ToString();
            string text7 = SwingSpeed.ToString();
