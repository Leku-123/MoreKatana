...
namespace MoreKatana.Items.Katana.TerraKatanaTree
{
    public class GrassKatana : KatanaItem
    {
        ...
        public override void SetDefaultsItem()
        {
            ...
            Item.MKItem().SetKatanaDefaults(Item, 0, true, ModContent.ProjectileType<GrassKatanaSwing>(), 3);
        }
        ...
        public override void ActiveSkill(Player player)
        {
            ...
            Projectile.NewProjectile(player.GetSource_ItemUse(Item), player.Center, randomVel, ModContent.ProjectileType<GrassKatanaDance>(), Item.damage, Item.knockBack, player.whoAmI);
        }
